...
const { search, profile, dashboard, volunteerAsHero, withdrawFromHero, updateProfile } = require('../controllers/employees.controller');

router.get('/search', search);
router.get('/profile/:id', profile);
router.get('/dashboard', auth, requireRole('EMPLOYEE'), dashboard);
router.put('/profile', auth, requireRole('EMPLOYEE'), updateProfile);
